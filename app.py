...
if st.session_state['page'] == 'main':
    ...
    shopping_df = pd.DataFrame([{'Ingredient': ingredient.element.name, 'Amount': ingredient.present(), 'Unit': str(ingredient.amount.unit)} for ingredient in meal_plan['Shopping List'].values()])
